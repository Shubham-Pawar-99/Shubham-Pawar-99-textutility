    ...
    return (
        <>
            <div style={{ color: props.mode === "light" ? 'black' : 'white' }}>
                <h1>{props.heading}</h1>        {/* react Props */}
                <div className="mb-3">
                ...
                <button className="btn btn-primary m-2" onClick={HandleUPclick} >ConvertToUppercase</button>
                <button className="btn btn-primary m-2" onClick={HandleLOclick} >ConvertToLowercase</button>
                ...
                <button className="btn btn-primary m-2" onClick={HandleReverseclick} >Reverse</button>
            ...
            <div className="container my-3" style={{ color: props.mode === "light" ? 'black' : 'white' }}>
                ...
                <h3>Preview</h3>
                <p>{text.length > 0 ? text : "Enter the text above the box to the preview here"}</p>
            </div>
        </>
    )
}
